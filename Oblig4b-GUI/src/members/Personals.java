...
public class Personals {
    ...
    public Personals(String firstname, String surname, String ePostadr) {
        this.firstname = firstname.trim();
        this.surname = surname.trim();
        this.ePostadr = ePostadr.trim();
    }
    ...
    public boolean equals(Object object) {
        ...
        else if(object instanceof Personals) {
            Personals personals = (Personals) object;
            return Objects.equals(this.firstname, personals.getFirstname()) && Objects.equals(this.getSurname(), personals.getSurname());
        }
        return false;
    }

    public String toString() {
        return firstname + " " +surname + " " + ePostadr;
    }
}